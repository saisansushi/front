...
const GetName = (props: IGetName) => {
    ...
    return (
        ...
        >
                ...
                <DialogContentText>
                    <div>
                        ...
                        <ButtonGroup style={{width: '100%'}}>
                            <TextField label="Имя" autoFocus={true} value={name}
                                       onChange={changeInputName} onKeyPress={keyPressInput}/>
                            <Button variant="outlined" onClick={() => clickNoNameButton()}><PersonOutline/></Button>
                        </ButtonGroup>
                    </div>
            ...
            <DialogActions>
                <Button variant="outlined" onClick={() => clickExitButton()}><KeyboardReturn/></Button>

                <Button variant="outlined" onClick={() => clickOkButton()}>OK</Button>
            </DialogActions>
