...
const GetVendor = (props: IGetVendor) => {
    ...
    const vendorsList = () => {
        const vendorItem = props.vendors && props.vendors
            .filter(e => (e.showInTerminal === 1))
            .map(({vendorId, vendorName, locationVerified}) =>
                <Button variant="outlined" fullWidth={true} style={{marginBottom: '3px'}} key={vendorId}
                        onClick={() => {
    ...
    return (
        <Dialog open={true} maxWidth={'xs'}>
            ...
            <DialogContent>
                ...
                <Button fullWidth={true} variant="outlined" style={{height: '100%'}} onClick={() => {
