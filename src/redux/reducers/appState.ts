...
export default function appState(state = initialState, payload:{type:string; openOrderId:number; terminalId:number; initCompleted:boolean; networkError:boolean; preloader:boolean; }) {
